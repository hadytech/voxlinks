 ...
 * get_post_meta
 */
class Crowdfundly_Page_Template {
    ...
    public static function get_instance() 
    {
        ...
        if ( null == self::$instance ) {
            self::$instance = new Crowdfundly_Page_Template();
        }
    ...
    public function view_template( $template ) 
    {
        ...
        $file = CROWDFUNDLY_PUBLIC_PATH . 'templates/'. get_post_meta( $post->ID, '_wp_page_template', true );
