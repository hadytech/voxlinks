					...
					?>
						<div class="organization__slider"> 
							<div class="main agile">
								<?php
								$header_slider = [];
								$cover_image = ! empty( $company->cover_photo ) ? array_push( $header_slider, $company->cover_photo ) : null;
								if (! empty( $company->gallery ) ) {
									foreach ( $company->gallery as $item ) {
										array_push( $header_slider, $item );
									}
								}
								?>
								<div class="slider org-slider">
									...
									if ( ! empty( $header_slider ) ) :
										...
										?>
											<div>
												<img class="slide" src="<?php echo esc_url( $slide->source_path ); ?>" alt="<?php echo __('Slider image', 'crowdfundly'); ?>">
											</div>
										<?php 
										endforeach;
									endif;
							...
							<div class="row">
								<div class="col-12 col-md-4 organization__details-left">
									<div class="organization__info">
										...
										<?php 
										if ( ! empty( $company->socialProfiles ) ) : ?>
											<div class="organization__social">
												...
												<ul class="organization__social-list">
													...
													foreach($company->socialProfiles as $profile):
														...
														?>
														<li class="organization__social-item organization__social-item--<?php echo esc_attr( $profile->social_network->name ); ?>">
								...
								<div class="col-12 col-md-8">
									<div class="organization__details-inner">
										...
										<div class="organization__details-description">
									...
									<div class="row">
											...
											<div class="col-12 col-sm-6 col-md-4 col-lg-<?php echo esc_attr( $crowdfundly_recent_camp_col ); ?>">
												<a href="<?php echo esc_url( Crowdfundly_Settings::getSingleCampaingPagePermalink($campaign->slug) ); ?>" class="campaign-card">
													...
													<div class="campaign-card__top">
														...
														<img src="<?php echo esc_url( $logo ); ?>" alt="<?php echo __('Campaign slider image', 'crowdfundly'); ?>" class="campaign-card__img"> 
													</div>
													<?php endif; ?>
													...
													<div class="campaign-card__footer">
														<div class="progress progress--slim">
															<div class="progress__bar progress__bar--secondary" style="width: <?php echo esc_attr( round(($campaign->raised_amount*100)/$campaign->target_amount) . '%' ); ?>;"></div>
														</div>
										...
										?>
											<div class="col-12 d-flex align-items-center justify-content-center org-all-campaign-btn-wrap">
												<a href="<?php echo esc_url( Crowdfundly_Settings::getAllCampaignPageLinkByID() ); ?>" class="btn btn-primary organization-all-camp-btn">
